...
const FullWidthBg = ({src}) => {
    ...
    useEffect(()=>{
        ...
        //             scrub: 2.2,
        //             // markers: true,
        //             animation: gsap.from(ref.current, {backgroundSize: '120%'}),
    ...
    return (
        <div className="full-width-bg" >
            <div className="bg" ref={ref} style={{backgroundImage: `url(<%= path %>/${src})`}}></div>
        </div>
    )
}
            ...
            <div className="flex">
                ...
                <div className="content">
                    <div className="wrap" ref={contentRef}>
                        ...
                        <div className="audio">
                            <div className="title"><span>Listen</span></div>
